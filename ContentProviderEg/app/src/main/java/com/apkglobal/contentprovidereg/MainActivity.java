package com.apkglobal.contentprovidereg;
                            ...
                            .setAction("Grant Access", new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if (ActivityCompat.shouldShowRequestPermissionRationale(MainActivity.this, READ_CONTACTS)) {
                                        ...
                                        //URI consists of a scheme such as HTTPS Or FILE or In our case PACKAGE
                                        // followed by scheme in the URI is SSP Scheme Specific Part
